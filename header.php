	...
	<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
		...
		<style>
			...
			#header {
				...
				background: linear-gradient(to right, yellow, #780206); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						<li><a href="#"><i class="fa fa-inr"></i> Xin Chào !</a></li>
						<li><?php
						include "db.php";
						if(isset($_SESSION["uid"])){
							...
							<a href="" data-toggle="modal" data-target="#profile"><i class="fa fa-user-circle" aria-hidden="true" ></i>Tài Khoản</a>
							...
							echo '
							<div class="dropdownn">
							<a href="#" class="dropdownn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-user-o"></i> Người Dùng</a>
							<div class="dropdownn-content">
					...
					<div class="col-md-3">
						<div class="header-logo">
							<a href="index.php" class="logo">
								<img src="img/logoGa.png" alt="logo">
							</a>						
						</div>
						<!-- <a href=""><img src='img/about.png' alt='abouteam' style='width:150px;margin-top:-25px;margin-left:26px' ></a> -->
					</div>
					<!-- /LOGO -->
						...
						<div class="header-ctn">
							...
							<div class="dropdown">
								...
								<div class="cart-dropdown"  >
									...
									<div class="cart-btns">
										<a href="cart.php" style="width:100%;"><i class="fa fa-edit"></i> Vào giỏ hàng</a>
