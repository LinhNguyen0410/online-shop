				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">'.$row['product_price'].' VND<del class="product-old-price"></del></h3>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Vĩnh</h5>
															<p class="date">02/05/2021, 18:30 PM</p>
													...
													<li>
														<div class="review-heading">
															...
															<p class="date">27/08/2018, 8:00 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star-o"></i>
																<i class="fa fa-star-o"></i>
										...
										<div class="col-md-3 mainn">
											<div id="review-form">
												<form class="review-form">
													...
													<textarea class="input" placeholder="Review"></textarea>
